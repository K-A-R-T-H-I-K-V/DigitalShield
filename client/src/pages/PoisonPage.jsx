  ...
  const handleProtectImage = async () => {
    ...
    try {
      ...
      const response = await axios.post(
        "http://localhost:5000/api/protect",
        formData,
        {
          headers: {
      ...
      const responseData = {
        ...
        data: {
          ...
          protectedSize:
            response.data.protectedSize ||
            `${((selectedFile.size * 1.05) / 1024).toFixed(2)} KB`,
      ...
      showToast(
        `Protection failed: ${error.response?.data?.error || error.message}`,
        ToastTypes.ERROR
      );
    } finally {
      clearInterval(interval);
    ...
    <div className="poison-page">
      <div className="page-header">
        ...
        <p className="page-subtitle">
          Protect your images from unauthorized AI training
        </p>
      </div>

      <div className="poison-content">
        <HolographicCard
          title="IMAGE POISONING MODULE"
          className="poison-card"
          glowColor="#00f0ff"
        >
                ...
                <div className="result-details">
                  <div className="result-grid">
                    ...
                    <div className="result-item">
                      ...
                      <div className="result-value">
                        {result.data.protectedSize}
                      </div>
                    </div>
                    {/* <div className="result-item">
                      <div className="result-label">POISON STRENGTH</div>
                      <div className="result-value">
                        {result.data.poisonStrength}
                      </div>
                    </div> */}
                    <div className="result-item">
                      <div className="result-label">NOISE PATTERN</div>
                      <div className="result-value">
                        {result.data.noisePattern}
                      </div>
                    </div>
                    <div className="result-item">
                    ...
                    {isPublic ? (
                      <div className="result-item">
                        ...
                        <div className="result-value cid-value">
                          {result.data.publicCid ||
                            "QmVRonNpNhHCsQPmi2pDVRrTTeqGgSBXUZjjyBpjFjRrdZ"}
                        </div>
                      </div>
                    ) : (
                      <>
                        <div className="result-item">
                          ...
                          <div className="result-value cid-value">
                            {result.data.encryptedCid ||
                              "Qmd9miaTiYdQXw2nNnL33ULZprgVEsZ9tfSX9JBoXvCzJE"}
                          </div>
                        </div>
                        <div className="result-item">
                  ...
                  <div className="next-steps">
                    <p>
                      Your image is now protected with advanced poisoning
                      techniques.
                    </p>
                    <div className="next-buttons">
                      <Link to="/track">
                        <FuturisticButton color="track">
                          PROCEED TO TRACKING
                        </FuturisticButton>
                      </Link>
                    </div>
        ...
        >
          <div className="info-content">
            ...
            <div className="info-section">
              ...
              <p>
                The embedded patterns are invisible to the human eye but
                effectively prevent AI models from learning from your images
                without permission.
              </p>
            </div>
            ...
            <div className="info-section">
              ...
              <p>
                Adjust the poison level to balance between protection strength
                and image quality preservation based on your specific needs.
              </p>
            </div>
